...
import { DiagnosticoAnuncios } from '@/components/print/DiagnosticoAnuncios';

const STATE_KEY = 'mrl.state.v3';

/** Documento imprimible (README § 9). */
export default function DiagnosticoAnunciosPage() {
  ...
  return (
    <>
      ...
      <div className="doc">
        <DiagnosticoAnuncios state={state} date={date} />
      </div>
    </>
  );
}
